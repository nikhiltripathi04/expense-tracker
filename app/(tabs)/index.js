...
export default function HomeScreen() {
  const { expenses, deleteExpense, getTotalExpenses, currency } = useContext(ExpenseContext);
  ...
  return (
    <View style={styles.container}>
      <View style={styles.totalContainer}>
        ...
        <Text style={styles.totalAmount}>{currencySymbol}{getTotalExpenses().toFixed(2)}</Text>
